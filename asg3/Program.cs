...
namespace asg3
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Constants
            const float price = 125f;
            //const decimal rate = 125.00m;
            //const decimal tax = 0.0625m;
            //const decimal fee = 15.00m;
            string tableHeaders = String.Format("{0,-15:s}{1,-10:s}{2,-7:s}{3,-7:s}{4,-7:s}{5,-7:s}", "Name", "Date In", "rooms", "nights", "C/C", "Total ($)");
            ...
            Reservation[] resArray = new Reservation[10];
            ...
            do
            {
                ...
                if (menuInput.ToLower().Equals("r"))
                {
                    ...
                    //Calculate total and print to console (Spec 4c)
                    //total = (rate * (1 + tax) + fee) * nights * rooms;//old
                    total = (decimal)Reservation.ComputeTotalDue(price, nights, rooms);
                    ...
                    if (subMenuInput.ToLower().Equals("a"))
                    {
                        ...
                        //Create Reservation object (Spec. 4d)
                        Reservation r = new Reservation(name, date, nights, rooms, creditCard);
            ...
            {
                string line =  resArray[i].ToString() + string.Format("{0, -7:0.00}", resArray[i].ComputeTotalDue());
                C.WriteLine(line);
            }
